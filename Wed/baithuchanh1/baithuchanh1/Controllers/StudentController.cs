    ...
    public class StudentController : Controller
    {
        ...
        public StudentController()
        {
            students = new List<Student>()
            {
                ...
                new Student(){ Id = 2, Name = "Minh Tu", Branch = Branch.BE , Gender = Gender.famale , Email = "minhtu@gmail.com", Address = "A1-2019", IsRegular = true, Diem = 7.0 },
                ...
                new Student(){ Id = 4, Name = "Thu Hang", Branch = Branch.CE , Gender = Gender.famale , Email = "thuhang@gmail.com", Address = "A1-2021", IsRegular = false, Diem = 8.0 }
            };
        }
