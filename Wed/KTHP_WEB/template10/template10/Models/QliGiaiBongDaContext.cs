...
public partial class QliGiaiBongDaContext : DbContext
{
    public QliGiaiBongDaContext()
    {
    }

    public QliGiaiBongDaContext(DbContextOptions<QliGiaiBongDaContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-FTUKUSM;Initial Catalog=QLiGiaiBongDa;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False", x => x.UseNetTopologySuite());

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Caulacbo>(entity =>
        {
            entity.HasKey(e => e.CauLacBoId).HasName("PK__CAULACBO__144BAB43D0DD390C");
        ...
        {
            entity.HasKey(e => e.HuanLuyenVienId).HasName("PK__HUANLUYE__8DF5FB21C50C4EA9");
        ...
        modelBuilder.Entity<Trandau>(entity =>
        {
            ...
            entity.ToTable("TRANDAU", tb => tb.HasTrigger("SoTranDau"));
        ...
        {
            entity.HasKey(e => e.TrongTaiId).HasName("PK__TRONGTAI__94867D371DC7434D");
