...
{
    public partial class BTT3_2_1 : Form
    {
        ...
        public BTT3_2_1(BaiTapDienTu baiTap)
        {
            InitializeComponent();
            bt = baiTap;
            rtbDebai.Text = bt.Debai;
        }
        ...
        {
            rtbDebai.Text = bt.Dapan;
        }

        private void button3_Click(object sender, EventArgs e)
        {
            foreach (Control control in grbdientu.Controls)
            {
