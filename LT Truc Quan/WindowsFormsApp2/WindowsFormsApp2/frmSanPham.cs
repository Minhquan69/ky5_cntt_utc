...
namespace WindowsFormsApp2
{
    ...
    {
        WindowsFormsApp2.DataProcesser dtBase = new WindowsFormsApp2.DataProcesser();
        string imageName = "";
        ...
        {
            DataTable dtCL = dtBase.ReadData("SELECT * FROM tblHang");
            cboChatLieu.DataSource = dtCL;
            cboChatLieu.DisplayMember = "Chatlieu";
            // cboChatLieu.ValueMember = "MaChatlieu"; // Uncomment if needed
        }
        void LoadData()
        {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            string sql = $"INSERT INTO tblHang VALUES ('{txtMa.Text}', N'{TxtTen.Text}', '{cboChatLieu.Text}', " +
