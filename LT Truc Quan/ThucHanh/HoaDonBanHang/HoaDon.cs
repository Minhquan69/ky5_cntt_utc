...
namespace HoaDonBanHang
{
    public partial class HoaDon : Form
    {
        ...
        private void cbMaNV_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable dtNhanVien = dtBase.ReadData($"SELECT TenNhanVien FROM tblNhanVien WHERE MaNhanVien = '{selectedMaNV}'");
            ...
            else
            {
                ...
                MessageBox.Show("Không tìm thấy nhân viên với mã " + selectedMaNV);
            }
        }
        ...
        // Kiểm tra nếu btnLuuHD đang ở trạng thái Enabled
